...
#Directory Listings
mkdir $HOME/WRFCHEM
mkdir $HOME/WRFCHEM/MET-10.1.2
mkdir $HOME/WRFCHEM/MET-10.1.2/Downloads
...
cd $HOME/WRFCHEM/MET-10.1.2/Downloads
...
cp compile_MET_all.sh $HOME/WRFCHEM/MET-10.1.2
tar -xvzf tar_files.tgz -C $HOME/WRFCHEM/MET-10.1.2
cp met-10.1.2.20220516.tar.gz $HOME/WRFCHEM/MET-10.1.2/tar_files
cd $HOME/WRFCHEM/MET-10.1.2
...
export TEST_BASE=$HOME/WRFCHEM/MET-10.1.2
...
export PATH=$HOME/WRFCHEM/MET-10.1.2/bin:$PATH            #Add MET executables to path

cd 
$HOME/WRFCHEM-4.4-install-script-linux-64bit/METplus_self_install_script_Linux_64bit.sh
